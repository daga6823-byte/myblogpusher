...
public class UserMaster {
    ...
    public Integer getRegPort() { return regPort; }
    public void setRegPort(Integer regPort) { this.regPort = regPort; }

    public String getRegHostname() { return regHostname; }
    public void setRegHostname(String regHostname) { this.regHostname = regHostname; }
    ...
    public void setRole(int i) { this.role = i; }
